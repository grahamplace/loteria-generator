...
const COPY = {
  en: {
    ...
    heading: "We've made Lotería Generator better",
...
export function reengagementSubject(locale: 'en' | 'es'): string {
  return locale === 'es'
    ? `🎉 ${REENGAGEMENT_DISCOUNT_PERCENT}% de descuento — vuelve a Lotería Generator`
    : `🎉 ${REENGAGEMENT_DISCOUNT_PERCENT}% off — come back to Lotería Generator`;
}
